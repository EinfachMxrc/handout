 ...
 * die UI (useQuery) nicht in einen Error-State kippt. Queries werden häufig
 * zwischen Routen re-ausgeführt; ein kurzzeitig ungültiger Token oder eine
 * gelöschte Session soll nicht das ganze Dashboard crashen.
 */
